        ...
        document.getElementById("header-lang-img") &&
            ("en" == e ?
                (document.getElementById("header-lang-img").src =
                    "/assets/admin/images/flags/us.jpg") :
                "sp" == e ?
                (document.getElementById("header-lang-img").src =
                    "/assets/admin/images/flags/spain.jpg") :
                "gr" == e ?
                (document.getElementById("header-lang-img").src =
                    "/assets/admin/images/flags/germany.jpg") :
                "it" == e ?
                (document.getElementById("header-lang-img").src =
                    "/assets/admin/images/flags/italy.jpg") :
                "ru" == e &&
                (document.getElementById("header-lang-img").src =
                    "/assets/admin/images/flags/russia.jpg"),
                localStorage.setItem("language", e),
                null == (t = localStorage.getItem("language")) && n(s),
                a.getJSON("/assets/admin/lang/" + t + ".json", function(e) {
                    a("html").attr("lang", t),
    ...
    a("#side-menu").metisMenu(),
        ...
        a(document).ready(function() {
            ...
            0 < a("#sidebar-menu").length &&
                ...
                ((e -= 300),
                    a(".vertical-menu .simplebar-content-wrapper").animate({ scrollTop: e },
                        "slow"
                    ));
        }),
